    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="category_id[]" id="category_id" class="form-select2" multiple="multiple">
                    @foreach($categories as $category)
                        <option value="{{ $category->id }}" class="cat-{{ $category->id }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Enter product name!" value="{{ $product->product_name }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="price" id="price" class="form-control" placeholder="Enter product price!" value="{{ $product->price }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                @if($product->image)
                    <img src="{{ asset('public/images/' . $product->image) }}" alt="Product Image" class="img-thumbnail mt-2" style="max-width: 200px;">
                @endif
            </div>
